...
import {
  ...
  Home, UserCog, Calculator, CreditCard, Wallet, FileSpreadsheet,
} from "lucide-react";
...
const navItems = {
  manager: [
    ...
    { label: "Maintenance Bills", icon: Receipt, path: "/maintenance" },
    { label: "Generate Bills", icon: Calculator, path: "/maintenance/generate" },
    { label: "Record Payment", icon: CreditCard, path: "/maintenance/payment" },
    { label: "Collection Dashboard", icon: Wallet, path: "/maintenance/collection" },
    { label: "Maintenance Settings", icon: FileSpreadsheet, path: "/maintenance/settings" },
  ...
  member: [
    { label: "Dashboard", icon: LayoutDashboard, path: "/" },
    { label: "Transactions", icon: ArrowLeftRight, path: "/transactions" },
    { label: "My Bills", icon: Receipt, path: "/maintenance/my-bills" },
    { label: "Reports", icon: BarChart3, path: "/reports" },
    { label: "Notifications", icon: Bell, path: "/notifications" },
  ],
};
